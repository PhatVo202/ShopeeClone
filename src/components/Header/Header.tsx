...
import { currentLanguages } from "src/i18n/i18n";
...
export const Header = () => {
  ...
  const currentLanguage = currentLanguages[i18n.language as keyof typeof currentLanguages]
      ...
      <div className="container">
        <div className=" text-white">
          <div className="flex justify-end ">
                ...
                renderPopover={
                  <div className='relative rounded-sm border border-gray-200 bg-white shadow-md'>
                    <div className='flex flex-col py-2 pr-28 pl-3'>
                      <button className='py-2 px-3 text-left hover:text-orange' onClick={() => handleChangeLanguage('vi')} >
                        Tiếng Việt
                      </button>
                      <button className='mt-2 py-2 px-3 text-left hover:text-orange' onClick={() => handleChangeLanguage('en')} >
                        English
                      </button>
                    </div>
                  </div>
            ...
            {
              !isAuthenticated && <>
                <Link to='/register' className="mx-3 hover:text-gray-300">Đăng ký</Link>
        ...
        <div className="grid grid-cols-12 gap-4 items-end mt-4">
          <Link className="col-span-2" to='/login'>
            <svg viewBox='0 0 192 65' className='h-9 lg:h-11 fill-white'>
              <g fillRule='evenodd'>
